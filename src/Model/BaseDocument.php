...
abstract class BaseDocument
{
    ...
    /**
     * @param array|null $created_by E-mail do usuário que será definido como criador do documento, para fins de organização interna.
     * @return BaseDocument
     */
    public function setCreatedBy(?array $created_by): BaseDocument
    {
